...
/// Layar Daily Quest — menampilkan 3 quest harian dan progress XP hari ini.
...
class _DailyQuestScreenState extends State<DailyQuestScreen> {
  ...
  Future<void> _loadQuests() async {
    ...
    try {
      final data = await DailyQuestService.getDailyQuests();
        ...
        children: [
          Row(
            children: [
              ...
              const Spacer(),
              // XP Badge — menampilkan todayXp / maxXp
              if (_data != null)
                Container(
